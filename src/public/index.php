 ...
 * Removes every programming language with less than a number of repositories using it as their main language
 * to prevent random.php from always returning the same repositories.
 */
$langList = $repoCache->langList($config['repoCache']['minLang']);
?>
        ...
        <div class="container">
            ...
            <footer>
                ...
                <div id="about-container" class="footer-menu-container">
                    <p>Website created by <a href="https://github.com/Max840" target="_blank">Maxime Plante</a> and <a href="https://github.com/berseker59" target="_blank">Maxence Frenette</a>.</p>
                    <a href="https://github.com/Max840/randomgit/" target="_blank"><strong>Official GitHub repository</strong></a>
                </div>
            ...
            <div id="next-repo">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <span id="history-btn" class="glyphicon glyphicon-list pull-right"></span>
                    </div>
                    <div class="panel-heading">
                        <%=description%>
                    </div>
